...
const projects = [
    {
        ...
        description: "Built and shipped a Next.js website for a live music school — MongoDB-backed, deployed on Vercel, serving real students and instructors in production.",
    ...
    },
    {
        ...
        description: "Full stack project management platform with user authentication, task tracking, and team workspaces — hosted on AWS Amplify with a PostgreSQL backend.",
        stack: [
            { name: "Next.js" },
            { name: "AWS" },
            { name: "Node.js" },
    ...
    },
    {
        ...
        category: "Lynxai",
        title: "Lynxai",
        description: "Core engineer at an ESG fintech startup — architected the fullstack infrastructure powering real-time sustainability data analysis for institutional investors.",
    ...
    },
    {
        ...
        category: "Recycular",
        title: "Recycular",
        description: "React Native mobile app for a circular economy brand — users scan QR codes on recyclable products to unlock rewards, backed by AWS.",
